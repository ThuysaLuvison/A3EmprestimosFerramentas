package visao;
 ...
 /**
 * Classe responsável por fornecer o menu principal da aplicação.
 * Permite acessar diferentes funcionalidades, como cadastro de ferramentas, cadastro de amigos, visualização de relatórios e opção de sair.
 * Esta classe utiliza outras classes para exibir as funcionalidades correspondentes.
 * O menu é composto por opções de "Opções" e "Sobre".
 *
 * @author Thuysa
 */
public class FrmMenuPrincipal extends javax.swing.JFrame {
    ...
    /**
     * Cria uma nova instância do formulário FrmMenuPrincipal.
